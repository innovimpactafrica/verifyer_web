...
export class RenouvellementComponent {
  constructor(private sanitizer: DomSanitizer) { }

  stats = {
    demandes: { count: 2, change: '2 terminées cette semaine' },
    enCours: { count: 1, change: '+3 ce mois' }
  };
  ...
  renouvellements = [
    {
      ...
      status: 'Demande de renouvellement',
      statusColor: 'text-[#2388FF] bg-[#2388FF14]'
    },
    {
      id: 'CERT-002',
      name: 'Hôtel du Parc',
      type: 'Hôtel',
      icon: 'bed',
      iconColor: 'text-[#D6AB17] bg-[#D6AB170F]',
      dateEmission: '20/10/2022',
      dateExpiration: '20/10/2023',
      score: 90,
      scorePercentage: 90,
      scoreColor: 'bg-emerald-600',
      status: 'En cours de renouvellement',
      statusColor: 'text-[#D6AB17] bg-[#D6AB170F]'
    },
    {
      id: 'CERT-001',
      ...
      type: 'Artisan',
      icon: 'tools',
      iconColor: 'text-[#2388FF] bg-[#274B9B14]',
      dateEmission: '15/08/2022',
      dateExpiration: '15/08/2023',
      score: 78,
      scorePercentage: 78,
      scoreColor: 'bg-[#D6AB17]',
      status: 'Demande de renouvellement',
      statusColor: 'text-[#2388FF] bg-[#2388FF14]'
    }
  ];
  ...
  getBienColor(type: string): string {
    switch (type) {
      ...
      case 'Hôtel':
        return 'text-[#D6AB17] bg-orange-50';
      case 'Restaurant':
