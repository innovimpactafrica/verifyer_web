...
export class ActivitesComponent implements OnInit {
  ...
  // Bar chart - Comparatif par zone (Demandes / Certificats)
  public zoneBarChartType: ChartType = 'bar';
  public zoneBarChartData: ChartConfiguration['data'] = {
  ...
  public zoneBarChartOptions: ChartConfiguration['options'] = {
    responsive: true,
    //maintainAspectRatio: false,
    plugins: {
      legend: {
  ...
  // Bar chart - Comparatif "Immobilier vs Artisanat"
  public sectorBarChartType: ChartType = 'bar';
  public sectorBarChartData: ChartConfiguration['data'] = {
    labels: ['S1', 'S2', 'S3', 'S4', 'S5', 'S6'],
    datasets: [
      {
        label: 'Immobilier',
        data: [15, 20, 22, 11, 18, 28],
        backgroundColor: '#0D823B',
        barThickness: 24,
      },
      {
        label: 'Artisanat',
        data: [5, 15, 17, 8, 14, 22],
        backgroundColor: '#274B9B',
        barThickness: 24,
      },
    ],
  ...
  public sectorBarChartOptions: ChartConfiguration['options'] = {
    responsive: true,
    //maintainAspectRatio: false,
    plugins: {
      legend: {
  ...
  // Logique d'affichage des icônes pour la colonne Secteur
